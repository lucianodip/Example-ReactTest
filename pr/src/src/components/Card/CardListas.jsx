...
export default function CardListas({data}) {
                ...
                <div className="container-tabla">
                    <div className="tabla tabla-candidatos">
                        ...
                        <div className="container-tabla__subtitulo">
                            <h5 className="tabla__subtitulo-type"><span>Listas</span></h5>
                        ...
                        <div key={el.nroLista} className="tabla__row">
                            <div className="tabla__data">
                                <img src={el.imagenLista} alt="imagen-candidato"/>
                                <p className="tabla__data-name"><span>{el.nombreLista}</span></p>
                            </div>
