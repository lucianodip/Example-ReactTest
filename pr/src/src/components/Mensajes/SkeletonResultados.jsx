...
export default function SkeletonResultados() {
  return (
    <>    
        <SkeletonTheme 
            baseColor="#CED4DA" 
            ...
            <Container className="seccion-resultados">
                <div className="cabecera-resultados" style={{padding:'16px'}}>
                ...
                <div className="container-tabla">
                    <div className="tabla tabla-candidatos">
                        <div className="tabla__head">
                            ...
                            <h4 className="tabla__head__titulo "><span><Skeleton width={100}/></span></h4>
                        </div>
                        <div className="container-tabla__subtitulo">
                            <span><Skeleton width={50}/></span>
                            <span><Skeleton width={100}/></span>
